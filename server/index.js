...
const uri = `mongodb+srv://arafat-demo-user:T4iGLhhcf5G9qYNq@cluster0.3myda.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
...
async function run() {
  ...
  app.get("/", (req, res) => {
    res.send("Welcome to test websites server side !!!");
  });
